...
export class ApiToolsService {
   ...
   * @throws ApiError
   */
  public static getApiToolApiV1ApiToolsToolIdGet(toolId: number): CancelablePromise<ApiToolOut> {
    return __request(OpenAPI, {
      method: 'GET',
   ...
   * @throws ApiError
   */
  public static deleteApiToolApiV1ApiToolsToolIdDelete(toolId: number): CancelablePromise<void> {
    return __request(OpenAPI, {
      method: 'DELETE',
      url: '/api/v1/api-tools/{tool_id}',
      path: {

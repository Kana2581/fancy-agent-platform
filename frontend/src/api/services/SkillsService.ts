...
export class SkillsService {
  public static createSkill(requestBody: SkillCreate): CancelablePromise<SkillOut> {
  ...
  public static getSkill(skillId: number): CancelablePromise<SkillOut> {
    return __request(OpenAPI, {
      method: 'GET',
  ...
  public static deleteSkill(skillId: number): CancelablePromise<void> {
    return __request(OpenAPI, {
      method: 'DELETE',
      url: '/api/v1/skills/{skill_id}',
      path: {

...
export class AgentsService {
   ...
   * @throws ApiError
   */
  public static getAgentApiV1AgentsAgentIdGet(agentId: number): CancelablePromise<AgentFullOut> {
   ...
   * @throws ApiError
   */
  public static createAgentApiV1AgentsPost(requestBody: AgentCreate): CancelablePromise<AgentOut> {
    return __request(OpenAPI, {
      method: 'POST',
      url: '/api/v1/agents/',
      body: requestBody,

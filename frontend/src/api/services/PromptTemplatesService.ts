...
export class PromptTemplatesService {
  ...
  public static getPromptTemplate(templateId: number): CancelablePromise<PromptTemplateOut> {
    return __request(OpenAPI, {
      method: 'GET',
  ...
  public static deletePromptTemplate(templateId: number): CancelablePromise<void> {
    return __request(OpenAPI, {
      method: 'DELETE',
      url: '/api/v1/prompt-templates/{template_id}',
      path: {

...
export class ScheduledTasksService {
   ...
   * @throws ApiError
   */
  public static deleteTaskApiV1ScheduledTasksTaskIdDelete(taskId: number): CancelablePromise<any> {
    return __request(OpenAPI, {
      method: 'DELETE',
      url: '/api/v1/scheduled-tasks/{task_id}',
      path: {
   ...
   * @throws ApiError
   */
  public static runTaskNowApiV1ScheduledTasksTaskIdRunPost(taskId: number): CancelablePromise<any> {
    return __request(OpenAPI, {
      method: 'POST',
